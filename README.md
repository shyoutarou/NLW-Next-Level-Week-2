...
1. Faça o *fork* do projeto (<https://github.com/shyoutarou/NLW-Next-Level-Week-2.git>)

2. Clone o seu *fork* para sua maquína (`git clone https://github.com/user_name/NLW-Next-Level-Week-2.git`)
